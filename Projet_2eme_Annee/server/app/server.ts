...
import { SocketIOController } from "./websocket/socket.controller";

export let ioSocket: SocketIO.Server;
...
export class Server {
    ...
    public init(): void {
        ...
        ioSocket = require("socket.io")(this.server);
        this.server.listen(this.appPort);
        this.server.on("error", (error: NodeJS.ErrnoException) => this.onError(error));
        this.server.on("listening", () => this.onListening());
        useSocketServer(ioSocket, {
